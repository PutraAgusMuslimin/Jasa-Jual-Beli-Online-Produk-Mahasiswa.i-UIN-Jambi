		...
		<body>
			<div id="header">
				<div>
					...
					<div class="inlinecenterblock">
						<h1 style="margin: 0px; font-size: 40px; color: <?php echo $maincolor ?>; font-weight: bold;"><a href="<?php echo $baseurl ?>"><?php echo $websitetitle ?></a></h1>
			...
			<div class="section footercopyright">
				<span>© <?php echo date("Y"); ?> <?php echo $websitetitle; ?>. Mas-Putra.</span>
			</div>
